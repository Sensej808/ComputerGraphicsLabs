...
namespace _3D_Labs
{
    public partial class FormLab6 : Form
    {
        ...
        public FormLab6()
        {
            ...
            this.scene = new Scene(new List<Polyhedron>(), new Camera(), g, pen, bitmap, pictureBox1, richTextBox1);
