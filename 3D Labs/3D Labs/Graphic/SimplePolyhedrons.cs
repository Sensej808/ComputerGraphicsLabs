...
namespace _3D_Labs.Graphic
{
    public class SimplePolyhedrons
    {
        public static Objects.Polyhedron Cube(float edgeLength)
        {
            ...
            point2.color = Color.FromArgb(0, 255, 0);
            point3.color = Color.FromArgb(0, 0, 0);
            point4.color = Color.FromArgb(0, 0, 255);
            point5.color = Color.FromArgb(255, 0, 0);
            point6.color = Color.Aqua;
            point7.color = Color.Orange;
            point8.color = Color.Gray;
