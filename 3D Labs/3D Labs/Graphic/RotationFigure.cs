        ...
        public static Polyhedron Create(List<Objects.Point> points, int axis, int partitionsCount)
        {
            ...
            for (int i = 0; i < partitionsCount; i++)
            {
                for (int j = 0; j < points.Count-1; j++)
                {
                    ...
                    //faces.Add(new Face(new List<Objects.Point> { resPoints[leftBottom], resPoints[leftTop], resPoints[rightTop] }));
                    //faces.Add(new Face(new List<Objects.Point> { resPoints[leftBottom], resPoints[rightTop], resPoints[rightBottom] }));
